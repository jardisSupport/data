...
class GetPropertyValueTest extends TestCase
{
    ...
    public function testCachesNegativeResultForNonExistentProperty(): void
    {
        $entity = new class {
            private string $name = 'John';
        };

        // First call - caches that property doesn't exist
        $result1 = $this->getPropertyValue->__invoke($entity, 'non_existent');
        $this->assertNull($result1);

        // Second call - uses cached negative result

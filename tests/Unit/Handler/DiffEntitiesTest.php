...
class DiffEntitiesTest extends TestCase
{
    ...
    {
        $entity1 = new class(new DateTime('2024-01-15 10:00:00')) {
        ...
        $entity2 = new class(new DateTimeImmutable('2024-01-15 10:00:00')) {
        ...
        // Cross-type comparison: same timestamp should be equal
        // Note: These are different anonymous classes, so DiffEntities will throw.
        // Instead, test via valuesAreEqual indirectly with same-class entities
        // that store DateTimeInterface.
        ...
        // Same timestamp — should be considered equal
        $this->assertEmpty($diff);
    }

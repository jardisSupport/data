...
class TypeCasterTest extends TestCase
{
    ...
    public function testParsesDateTimeFromDateFormatWithZeroTime(): void
    {
        $entity = new class {
    ...
    public function testParsesDateTimeFromTimeFormat(): void
    {
        ...
        $this->assertEquals('1970-01-01', $result->format('Y-m-d'));
    }
    ...
    public function testParsesDateTimeImmutableFromFullFormat(): void
    {
        $entity = new class {
    ...
    public function testParsesDateTimeImmutableFromDateFormatWithZeroTime(): void
    {
        $entity = new class {
    ...
    public function testReturnsDateTimeImmutableObjectAsIs(): void
    {
        $entity = new class {
            private DateTimeImmutable $createdAt;
        };
        ...
        $dateTime = new DateTimeImmutable('2024-01-15 14:30:45');
        $result = $this->typeCaster->__invoke($dateTime, $property);

        $this->assertSame($dateTime, $result);
    }

    public function testReturnsNullForInvalidDateTimeImmutableString(): void
    {
        $entity = new class {
            private DateTimeImmutable $createdAt;
        };
    ...
    public function testReturnsNullForEmptyDateTimeImmutableString(): void
    {
        $entity = new class {
            private DateTimeImmutable $createdAt;
        };
    ...
    public function testCastsStringToBackedEnum(): void
    {
        $entity = new class {
            private GatewayType $type;
        };
        $property = new ReflectionProperty($entity, 'type');

        $result = $this->typeCaster->__invoke('ELECTRICITY', $property);

        $this->assertSame(GatewayType::Electricity, $result);
    }

    public function testReturnsBackedEnumObjectAsIs(): void
    {
        $entity = new class {
            private GatewayType $type;
        };
        ...
        $result = $this->typeCaster->__invoke(GatewayType::Gas, $property);

        $this->assertSame(GatewayType::Gas, $result);
    }

    public function testConvertsDateTimeImmutableToDateTime(): void
    {
        $entity = new class {
            private DateTime $createdAt;
        };
        ...
        $immutable = new DateTimeImmutable('2024-01-15 14:30:45');
        $result = $this->typeCaster->__invoke($immutable, $property);

        $this->assertInstanceOf(DateTime::class, $result);
        $this->assertEquals('2024-01-15 14:30:45', $result->format('Y-m-d H:i:s'));
    }

    public function testConvertsDateTimeToDateTimeImmutable(): void
    {
        $entity = new class {
            private DateTimeImmutable $createdAt;
        };
        ...
        $mutable = new DateTime('2024-01-15 14:30:45');
        $result = $this->typeCaster->__invoke($mutable, $property);

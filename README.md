...
[![Coverage](https://img.shields.io/badge/Coverage-96%25-brightgreen.svg)](https://github.com/jardisSupport/data)
...
- **Type Casting** — Automatic conversion of database strings to PHP types (int, bool, float, DateTime, DateTimeImmutable)
- **Deep Cloning** — Recursive deep clone of entities including nested objects and snapshots at all levels
- **Entity Diffing** — Compare two entities and get their differences (DateTime/DateTimeImmutable cross-comparable)
- **Aggregate Hydration** — Recursive hydration of nested objects, indexed and associative arrays of objects
...
- Properties (private, protected, or public) with optional getter/setter methods
- Getter methods: `get*()`, `is*()`, or `has*()` prefixes are all supported

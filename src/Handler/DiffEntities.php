...
class DiffEntities
{
    ...
    private function valuesAreEqual(mixed $value1, mixed $value2): bool
    {
        ...
        // DateTime: Compare timestamps (value comparison)
        if ($value1 instanceof DateTime && $value2 instanceof DateTime) {
            return $value1->getTimestamp() === $value2->getTimestamp();
        }

        // DateTimeImmutable: Compare timestamps (value comparison)
        if ($value1 instanceof DateTimeImmutable && $value2 instanceof DateTimeImmutable) {
            return $value1->getTimestamp() === $value2->getTimestamp();
        }
